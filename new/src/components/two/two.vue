<template>
    <div class="two">
        <div class="two-0 ani" swiper-animate-effect="lightSpeedIn
...
" swiper-animate-duration="1s" swiper-animate-delay="0.5s"></div>
            <div class="text ani" swiper-animate-effect="bounceInRight
" swiper-animate-duration="1s" swiper-animate-delay="0.5s"></div>
        </div>
    </div>
</template>
...
.two
    ...
    .text-wrap
        ...
        .border 
            ...
            width 100%
            height 70px
            background url('./11.png') center center no-repeat
            background-size contain
        .text
            position absolute
            width 100%
            height 70px
            background url('./10.png') center center no-repeat
            background-size contain
